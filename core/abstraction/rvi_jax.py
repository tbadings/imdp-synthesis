...
def RVI_JAX(
    ...
    np_successors_array = JAX_successors_array.copy()
    ...
    if not policy_iteration:
        ...
        for iteration in pbar:
            ...
            for state_batch in state_batches:
                sort_indices = np.argsort(V[np_successors_array[state_batch]], axis=-1)
        ...
        for iteration in pbar:
            ...
            while True: # TODO: Remove this hardcoding
                ...
                for state_batch in state_batches:
                    sort_indices = np.argsort(V[np_successors_array[state_batch, policy[state_batch]]], axis=-1)
